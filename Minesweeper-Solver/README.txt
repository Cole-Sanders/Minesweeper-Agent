Team 12:
Names: Rishabh Kala, Jay Joshi, Rohan Mathew, Cole Sanders
Unity IDs: rkala@ncsu.edu, jmjoshi@ncsu.edu, rjmathe2@ncsu.edu, cgsande2@ncsu.edu


After extracting the zip, three folders will be present:
1. UI: This contains the base UI which has been incorporated into the approaches.
2. stochastic_and_KB_minesweeper: This contains the two baseline approaches.
3. reinforcement_minesweeper_project: This contains the RL agent.

------------------------------------------------------------------------------------------------------------------------------------------

- For reinforcement_minesweeper_project folder:
...
- For stochastic_and_KB_minesweeper:
